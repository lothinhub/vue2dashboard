...
<template>
    <div class="bg-white">
        <div class="relative">
            <button class="absolute right-96 mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 drop-shadow-2xl" type="button" data-modal-toggle="default-modal">
            Create
            </button>
        </div>
