...
<template>
  <div class="flex">
    <div
      ...
      class="flex flex-col h-screen p-3 duration-300 bg-indigo-50 drop-shadow-2xl gap-10 text-fuchsia-600"
    >
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <h2 class="text-xl font-bold text-blue-700">People</h2>
